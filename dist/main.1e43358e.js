...
exports.CST = CST;
},{}],"src/scenes/Game.js":[function(require,module,exports) {
"use strict";
...
var Game = /*#__PURE__*/function (_Phaser$Scene) {
  ...
  _createClass(Game, [{
    ...
    value: function create() {
      ...
      var leftEdge = this.add.graphics({
        fillStyle: {
          color: 0xff8800
        }
      });
      var rigbtEdge = this.add.graphics({
        fillStyle: {
          color: 0xff8800
        }
      });
...
exports.Game = Game;
},{"../CST":"src/CST.js"}],"src/scenes/Load.js":[function(require,module,exports) {
"use strict";
...
var Load = /*#__PURE__*/function (_Phaser$Scene) {
  ...
  _createClass(Load, [{
    ...
    value: function preload() {
      ...
      this.load.image("Yukihana", "./assets/shooter.png"); //loading bar
...
var Menu = /*#__PURE__*/function (_Phaser$Scene) {
  ...
  _createClass(Menu, [{
    ...
    value: function create() {
      ...
      var playButton = this.add.image(this.game.renderer.height / 2, this.game.renderer.width / 2, "play");
...
exports.Menu = Menu;
},{"../CST":"src/CST.js"}],"src/scenes/Tutorial.js":[function(require,module,exports) {
"use strict";
...
var _Game = require("./scenes/Game");

var _Load = require("./scenes/Load");

var _Menu = require("./scenes/Menu");

var _Tutorial = require("./scenes/Tutorial");

/**@type {import("../typings/phaser")} */
var game = new Phaser.Game({
  width: 700,
  height: 700,
  scene: [_Load.Load, _Menu.Menu, _Tutorial.Tutorial, _Game.Game]
});
},{"./scenes/Game":"src/scenes/Game.js","./scenes/Load":"src/scenes/Load.js","./scenes/Menu":"src/scenes/Menu.js","./scenes/Tutorial":"src/scenes/Tutorial.js"}],"../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
